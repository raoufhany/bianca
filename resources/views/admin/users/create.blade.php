...
@endsection
@section('page_title')
{{trans('common.create '. $module_name_singular)}}
@endsection
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{trans('common.create '. $module_name_singular)}}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" novalidate
                            action="{{ route('admin.'.$module_name_plural.'.store') }}" method="POST" enctype="multipart/form-data">
