...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text" value="{{ isset($row) ? $row->phone_number : old('phone_number') }}" name="phone_number" class="form-control" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="{{trans('common.The numeric field may only contain numeric characters.')}}" placeholder="{{trans('common.Enter Phone Number')}}">
            </div>
            @error('phone_number')
            <small class=" text text-danger" role="alert">
                <strong>{{ $message }}</strong>
    ...
    <div class="col-md-6">
        ...
        <div class="media">
            <a href="javascript: void(0);">
                <img id="image" src="{{isset($row)? $row->image: asset('/admin_asset/app-assets/images/portrait/small/avatar-s-12.jpg')}}" class="rounded mr-75" alt="profile image" height="64" width="64">
            </a>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text" value="{{ isset($row) ? $row->longitude : old('longitude') }}" name="longitude" class="form-control" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="{{trans('common.The numeric field may only contain numeric characters.')}}" placeholder="{{trans('common.Enter longitude')}}">
            </div>
            @error('longitude')
            <small class=" text text-danger" role="alert">
                <strong>{{ $message }}</strong>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="controls">
                <input type="text" value="{{ isset($row) ? $row->latitude : old('latitude') }}" name="latitude" class="form-control" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="{{trans('common.The numeric field may only contain numeric characters.')}}" placeholder="{{trans('common.Enter latitude')}}">
            </div>
            @error('latitude')
            <small class=" text text-danger" role="alert">
                <strong>{{ $message }}</strong>
